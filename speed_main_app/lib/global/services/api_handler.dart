...
import '../model/prod_detail/ProductsModel.dart';
import '../model/user/user.dart';

import 'package:http/http.dart' as http;

class APIHandler {
  static Future<List<dynamic>> getData({String target, String limit}) async {
    try {
      var uri = Uri.https(
  ...
  static Future<List<ProductsModel>> getAllProducts({String limit}) async {
